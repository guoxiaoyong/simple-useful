...
#define wpa_msg_ctrl(args...)                                                  \
  do {                                                                         \
  } while (0)
#define wpa_msg_global(args...)                                                \
  do {                                                                         \
  } while (0)
#define wpa_msg_no_global(args...)                                             \
  do {                                                                         \
  } while (0)
#define wpa_msg_register_cb(f)                                                 \
  do {                                                                         \
  } while (0)
#define wpa_msg_register_ifname_cb(f)                                          \
  do {                                                                         \
  } while (0)
...
#define hostapd_logger(args...)                                                \
  do {                                                                         \
  } while (0)
#define hostapd_logger_register_cb(f)                                          \
  do {                                                                         \
  } while (0)
